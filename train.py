...
def train(epoch):
    ...
    print_class_acc(output[idx_train], labels[idx_train], class_num_mat[:,1])
    # for i in idx_train:
    #   if(labels[i]>3):
...
#       print(list2)
    ...
    #     for j in range(2708):
    #       if(classifier.attentions[0].weight[i][j]>0):
    #         list1.append(j)
    #         list2.append(np.asscalar(classifier.attentions[0].weight[i][j].cpu().detach().numpy()))
    #         list3.append(np.asscalar(labels[j].cpu().detach().numpy()))  
    #     print(list1)
    #     print(list3)
    #     print(list2) 
...
def compute_test(epoch=0):
    ...
    print_class_acc_test(output[idx_test], labels[idx_test], class_num_mat[:,2], pre='test')
